...
export default function LandingPage() {
  ...
  const features = [
    ...
    { icon: Code, title: 'AIA Blockchain Insights', description: 'Dive deep into the AIA blockchain and its innovative features.' },
    { icon: MessageSquare, title: 'Secure Transactions', description: 'Experience secure and decentralized transactions on AIA.' },
    { icon: MessageSquare, title: 'Build & Connect', description: 'Create applications and connect with the AIA blockchain community.' },
  ];
